...
class TopicCreate extends React.Component {
  ...
  handleCreate() {
    ...
    const result = this.props.topicStore.createTopic(title, tab, content)
    return result
      .then(() => {
    ...
    return (
      <Container>
        <div className={classes.root}>
          ...
          <Button variant="raised" color="primary" onClick={this.handleCreate} className={classes.replyButton}>
            <IconReply />
          </Button>
        </div>
      </Container>
